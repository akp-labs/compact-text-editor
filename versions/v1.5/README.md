# Compact Text Editor – v1.5

Version 1.5 is the second implementation of the Compact Text Editor.  
...
- Text area size maximized 
- Media query used to enhance responsiveness
- Colour theme updated and made consistent
- Allowed scroll 
